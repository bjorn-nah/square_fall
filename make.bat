...
C:\dev\gameboy\gbdk\bin\lcc -o square_fall.gb main.o title.o game_commons.o game.o gameover.o gbt_player.o gbt_player_bank1.o song_game.c song_gameover.o font.o utils.o
